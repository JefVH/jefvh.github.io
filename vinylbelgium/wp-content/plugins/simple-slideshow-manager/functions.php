	...
	if($acx_slideshow_js_array=="")
{
	...
	if($gal_found==0)
	{
		...
		The gallery group <b><?php echo $gallery_name; ?></b> is no longer available , Please Re-configure your widget/shortcode/php code which display's this slideshow.
		</div>
		<?php
	}
...
if($acx_slideshow_version < "1.2.3") // << Old Version // Current Verison
{
