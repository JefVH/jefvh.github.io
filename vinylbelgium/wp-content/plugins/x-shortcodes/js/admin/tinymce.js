      ...
      ed.add({
        ...
        onclick: function () {
          ...
          if(id === 'responsive-text') {
            tinyMCE.activeEditor.selection.setContent('[responsive_text selector=".responsive-heading" compression="1.2" min_size="24px" max_size="54px"] Look At Me, I\'m Responding! [/responsive_text]');
          }
          ...
          if(id === 'skill-bar') {
            tinyMCE.activeEditor.selection.setContent('[skill_bar heading="Heading" percent="95%"]');
          }
          ...
          if(id === 'author') {
            tinyMCE.activeEditor.selection.setContent('[author title="Title"]');
          }
          ...
          if(id === 'recent-posts') {
            tinyMCE.activeEditor.selection.setContent('[recent_posts type="post, portfolio" category="" count="1, 2, 3, 4" orientation="horizontal, vertical" no_image="true" fade="true"]');
          }
