<%@ Page Title="Ramen en deuren in duurzaam PVC - Deceuninck NV" Language="C#" MasterPageFile="~/masterpages/nl/PPSite.Master" AutoEventWireup="true" CodeFile="inspiratiemodule.aspx.cs" Inherits="index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section id="products" class="block left-xlarge">
        <h1 class="center-title">Inspiratie voor uw woning</h1>
          <div class="filters">
                <select id="land-list" name="Land"">
                    <option value="01">België</option>
                </select>
                <select id="projecttype-list" name="Projecttype">
                    <option value="11">Nieuwbouw</option>
                    <option value="12">Renovatie</option>
                </select>
                <select id="woonstijl-list" name="Woonstijl">
                    <option value="21">Pastorie</option>
                    <option value="22">Hoeve</option>
                    <option value="23">Modern</option>
                    <option value="24">Hedendaags</option>
                    <option value="25">Klassiek</option>
                    <option value="26">Kasteelhoeve</option>
                    <option value="27">Halfopen bebouwing</option>
                    <option value="28">Tuinpaviljoen</option>
                </select>
                <select id="product-list">
                    <option value="31">Ramen & Deuren</option>
                    <option value="32">Gevel</option>
                    <option value="33">Tuinomheining</option>
                    <option value="31">Terras</option>
                    <option value="31">Interieur</option>
                </select>
          </div>    
        <%--<nav class="filters">
            <ul id="filter">
