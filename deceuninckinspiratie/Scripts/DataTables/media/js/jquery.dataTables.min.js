...
sProp, mValue, json = [], bArr = $.isArray(o); for (sProp in o) {
        ...
        this.$ = function (sSelector, oOpts) {
            ...
            { $.extend(oSettings.aoPreSearchCols[iColumn], { "sSearch": sInput + "", "bRegex": bRegex, "bSmart": bSmart, "bCaseInsensitive": bCaseInsensitive }); _fnFilterComplete(oSettings, oSettings.oPreviousSearch, 1); } 
        ...
        oSettings.jqXHR = $.ajax({ "url": sUrl, "data": aoData, "success": function (json) {
    ...
    }); $.extend(DataTable.ext.oSort, { "string-pre": function (a) {
