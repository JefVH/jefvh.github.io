...
public partial class masterpages_Main_fr : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if ((Request.ServerVariables.Get("URL").Equals("/index.aspx")) || (Request.ServerVariables.Get("URL").Equals("/nl/index.aspx")) || (Request.ServerVariables.Get("URL").Equals("/fr/index.aspx")))
        {
