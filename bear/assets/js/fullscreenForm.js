;( function( window ) {
	...
	FForm.prototype._addControls = function() {
		...
		this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : 'Ga verder', appendTo : this.ctrls } );
	...
	FForm.prototype._showError = function( err ) {
		...
		switch( err ) {
			case 'NOVAL' : 
				message = 'Gelieve het veld in te vullen alvorens verder te gaan.';
				break;
			case 'INVALIDEMAIL' : 
				message = 'Gelieve een geldig email adres in te vullen.';
				break;
			// ...
		};
